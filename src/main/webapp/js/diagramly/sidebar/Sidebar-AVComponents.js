(function()
{
	// Adds Audio/Video Components shapes
	Sidebar.prototype.addAVCompoenntsPalette = function()
	{
		var sb = this;
		...
		var s = 0.3; //scale
		this.setCurrentSearchEntryLibrary('avc', 'avComponents');
		...
		this.addPalette('avComponents', 'AV Components', false, mxUtils.bind(this, function(content)
		{
